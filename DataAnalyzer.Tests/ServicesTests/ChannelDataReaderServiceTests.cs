...
//            _ft232DataReaderMock.Setup(reader => reader.ReadDataAsync(bufferSize))
//                                .Returns(mockData);
...
//            _ft232DataReaderMock.Verify(reader => reader.ReadDataAsync(bufferSize), Times.Once);
//        }
...
//            _ft232DataReaderMock.Setup(reader => reader.ReadData(bufferSize))
//                                .Returns(mockData);
...
//        //    uint bufferSize = 8;
//        //    var mockData = new byte[] { 0b10101010, 0b11001111, 0b11011100, 0b11101100, 0b01001100, 0b11001110, 0b11000100, 0b11001000 };
//        //    _ft232DataReaderMock.Setup(reader => reader.GenerateMockData(bufferSize))
//        //                        .Returns(mockData);
